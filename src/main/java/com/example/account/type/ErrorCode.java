...
public enum ErrorCode {
    ...
    TRANSACTION_NOT_FOUND("거래 내역이 없습니다."),
    AMOUNT_EXCEED_BALANCE("거래 금액이 계좌 잔액보다 큽니다."),
    TRANSACTION_ACCOUNT_UNMATCH("해당 계좌에서 발생한 거래가 아닙니다."),
    USER_ACCOUNT_UNMATCH("사용자와 계자의 소유주가 다릅니다."),
    CANCEL_MUST_FULLY("부분 취소는 혀용되지 않습니다."),
